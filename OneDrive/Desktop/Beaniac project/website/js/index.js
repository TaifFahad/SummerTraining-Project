    ...
    newButton1.addEventListener('click', function () {
      ...
      newButton3.addEventListener('click', function () {
        ...
        newButton6.addEventListener('click', function () {
          ...
          newButton5.remove();
          newButton6.remove();
          backgroundSection.style.backgroundImage = 'url("/website/media/res1.jpg")';
        ...
        newButton5.addEventListener('click', function () {
          ...
          newButton7.addEventListener('click', function () {
            ...
            newButton8.remove();
            newButton9.remove();
            backgroundSection.style.backgroundImage = 'url("/website/media/res2.jpg")';
            resault.textContent = "We Suggest For You To Order:"
          ...
          newButton9.addEventListener('click', function () {
            ...
            newButton8.remove();
            newButton9.remove();
            backgroundSection.style.backgroundImage = 'url("/website/media/res3.jpg")';
            resault.textContent = "We Suggest For You To Order:"
      ...
      newButton4.addEventListener('click', function () {
        ...
        newButton3.remove();
        newButton4.remove();
        backgroundSection.style.backgroundImage = 'url("/website/media/res4.jpg")';
        resault.textContent = "We Suggest For You To Order:"
    ...
    newButton2.addEventListener('click', function () {
      ...
      newButton3.addEventListener('click', function () {
        ...
        newButton6.addEventListener('click', function () {
          ...
          //hot amricano
          backgroundSection.style.backgroundImage = 'url("/website/media/res5.jpg")';
          newButton5.remove();
          newButton6.remove();
          resault.textContent = "We Suggest For You To Order:"
        ...
        newButton5.addEventListener('click', function () {
          ...
          newButton7.addEventListener('click', function () {
            ...
            newButton8.remove();
            newButton9.remove();
            backgroundSection.style.backgroundImage = 'url("/website/media/res6.jpg")';
            resault.textContent = "We Suggest For You To Order:"
          ...
          newButton9.addEventListener('click', function () {
            ...
            newButton8.remove();
            newButton9.remove();
            backgroundSection.style.backgroundImage = 'url("/website/media/res7.jpg")';
            resault.textContent = "We Suggest For You To Order:"
      ...
      newButton4.addEventListener('click', function () {
        ...
        newButton3.remove();
        newButton4.remove();
        backgroundSection.style.backgroundImage = 'url("/website/media/res8.jpg")';
